...
function addNotic() {
    if (!document.getElementById("zawgyi_noti")) {
        var i_have_zawgyi = '<marquee loop="2" class="i_have_zawgyi"><div class="mua_noti_text">ဤစာမျက်နှာတွင် ရှိသော ဇော်ဂျီဖြင့် ရေးထားသည့် စာများအား အလိုအလျောက် ပြောင်းလဲထားပါသည်။</div></marquee>';
        var notify_node = document.createElement("div");
        notify_node.setAttribute("id", "zawgyi_noti");
        var body = document.body;
        notify_node.innerHTML = i_have_zawgyi;
