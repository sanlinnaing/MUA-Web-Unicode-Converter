...
var converterFun=function(node){
...
converterFun(document.body);
//console.log("chrome fontsetting"+chrome.fontSettings);
//chrome.fontSettings.getFont({ genericFamily: 'standard', script: 'Mymr' },function(details) { console.log(details.displayName); });
